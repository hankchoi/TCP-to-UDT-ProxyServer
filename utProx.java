...
public class utProx extends Thread {
    ...
    public utProx(InetAddress srcAddr,int srcPort,
	...
	this.srvSock=new NetServerSocketUDT();
	//(srcAddr==null) ? this.srvSock.bind(InetSocketAddress(srcAddr, srcPort),backLog) :
	this.srvSock.bind(new InetSocketAddress(srcAddr,srcPort),backLog);
    ...
    private static utProx addProxy(String src,String srcPort, String dst, String dstPort,
					PrintStream out, PrintStream err) throws
					UnknownHostException, IOException
    {
	InetAddress srcAddr=(src==null) ? null : InetAddress.getByName(src);
	return new utProx(srcAddr,Integer.parseInt(srcPort),
